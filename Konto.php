   ...
   <main>
	  ...
	  <div class="przepisy container-fluid col-xs-12 col-sm-12 col-md-12 col-lg-12">
	   <section>
	     ...
	     <div align="center">
		 <?php
         echo "<b><h4>Witaj ".$_SESSION['login']."!</b></h4>"; 
         ?></h2><br>
		 Masz teraz możliwość dodania własnego przepisu. Naciśnij poniższy przycisk:<br/><br/>
	        <a href="addPrzepisy.php" class="btn btn-success pull center">Dodaj przepis</a>
    
            </br></br>
           W celu wylogowania naciśnij poniższy przycisk:<br/><br/>
          
			  <a href="wyloguj.php" class="btn btn-info pull center">Wyloguj</a>
