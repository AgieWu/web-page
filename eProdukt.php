            ...
            <div class="row">
                <div class="col-xs-12 col-sm-12 col-md-12">
                    <div class="page-header clearfix">
                        <h3 class="pull-left"><br>Edycja produktów</h3>
                        <br><a href="#one" class="btn btn-success pull-right">Dodaj lub usuń produkt</a>
						
             

			
            <form action="propozycjeins.php" method="post">
                <table class='table table-bordered table-striped table-responsive '><tr><td></td><td><b>NR</b></td><td><b>Nazwa</b></td><td><b>Kategoria</b></td><td><b>Opis</b></td><td><b>Cena</b></td><td><b>Adres zdjęcia</b></td></tr>
<?php
$numerWiersza=1;
...
<td><input type=text class="pole" name=kategoria></td>
<td><input type=text class="pole" name=opis></td>
<td><input type=text class="pole" name=cena></td>
